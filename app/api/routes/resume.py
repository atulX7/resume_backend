...
from app.services.resume_service import handle_resume_upload, handle_delete_resume, get_resume_download_url, \
...
async def update_resume_details(
    ...
    updated_resume_record = handle_resume_update(db, resume_id, current_user.id, updated_resume, title, resume_data)
